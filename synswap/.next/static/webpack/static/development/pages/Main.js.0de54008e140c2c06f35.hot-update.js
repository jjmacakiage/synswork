...
/* harmony import */ var react_loading_io__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! react-loading-io */ "./node_modules/react-loading-io/dist/bundle.esm.js");
...
/* harmony import */ var react_loading_overlay__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! react-loading-overlay */ "./node_modules/react-loading-overlay/lib/LoadingOverlay.js");
/* harmony import */ var react_loading_overlay__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(react_loading_overlay__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _utils_tradehelpers__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../utils/tradehelpers */ "./utils/tradehelpers.js");
...
function NewTradeContent(props) {
  ...
  var irsSchema = function irsSchema(values) {
    var generateSchema = function generateSchema(object, values) {
      var keys = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_6___default()(object);
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        if (typeof obj === 'string' || typeof obj === 'number') {
          result = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_5__["default"])({}, result, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])({}, key, values[valueCount]));
          valueCount++;
        } else {
          result = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_5__["default"])({}, result, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])({}, key, generateSchema(obj, values.slice(valueCount, valueCount + _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_6___default()(object).length))));
          valueCount = valueCount + _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_6___default()(object).length;
        }
      }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(values);
              data = irsSchema(_babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_2___default()(values));
              _context.prev = 3;
  ...
  function generateInitial(array, values) {
    ...
    for (var i = 0; i < array.length; i++) {
      result = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_5__["default"])({}, result, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])({}, array[i][0], values[i]));
    }
  ...
  function createFormColumns(array) {
    return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, null, array.map(function (value, index) {
      if (value[1] !== 'select') {
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Grid"], {
          item: true,
          xs: 4
        }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_14__["Field"], {
          name: value[0],
          key: value[0],
          type: value[1],
          render: function render(_ref2) {
            ...
            return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["TextField"], Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, field, {
        ...
        }), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_14__["ErrorMessage"], {
          name: value[0],
          component: "div"
        }));
      } else {
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Grid"], {
          ...
          render: function render(_ref3) {
            ...
            return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["TextField"], {
              select: true,
              disabled: counterparty === '' || isSubmitting,
              variant: "outlined",
              style: {
              ...
              value: value[0],
              SelectProps: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_5__["default"])({
                "native": true
              }, field)
  ...
  function extendedFields() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Grid"], {
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Grid"], {
        item: true,
        xs: 12
      }, index === 0 || index === 5 ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Typography"], {
        variant: "overline",
        style: {
          marginBottom: 20
        }
      }, index === 0 ? "Floating Leg" : "Fixed Leg") : null, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Grid"], {
        container: true,
        spacing: 2
  ...
  return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
  ...
  }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Typography"], {
    variant: "overline",
    style: {
      marginBottom: 20
    }
  }, " ", counterparty === '' ? 'New Trade' : counterparty), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react_loading_overlay__WEBPACK_IMPORTED_MODULE_15___default.a, {
    active: isLoading,
    spinner: react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react_loading_io__WEBPACK_IMPORTED_MODULE_13__["Eclipse"], null),
    styles: {
      overlay: function overlay(base) {
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_5__["default"])({}, base, {
          background: 'rgba(255, 255, 255, 0.1)'
        });
      }
    }
  }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_14__["Formik"], {
    ...
    render: function render(_ref4) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_14__["Form"], null, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["TextField"], {
        select: true,
        ...
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["MenuItem"], {
          key: value + index,
          value: value
        }, value);
      })), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Grid"], {
        container: true,
        spacing: 2
      ...
      }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Divider"], null)), extendedFields(), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Button"], {
        variant: "contained",
        type: "submit",
...
//# sourceMappingURL=Main.js.0de54008e140c2c06f35.hot-update.js.map