...
function NewTradeContent(props) {
      ...
      if (value[1] !== 'select') {
        ...
        return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_14__["Grid"], {
          ...
          render: function render(_ref3) {
            ...
            }, field), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("option", {
              disabled: true
            }, " ", value[0], " "), value[3].map(function (option) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
    ...
    onSubmit: function onSubmit(values, actions) {
      console.log(_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default()(values).length, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default()(irsSchema(_babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(values))).length);
...
//# sourceMappingURL=Main.js.3688a7c9eb93945dd498.hot-update.js.map