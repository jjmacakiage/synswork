...
function NewTradeContent(props) {
      ...
      if (value[1] !== 'select') {
        ...
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_13__["Grid"], {
          ...
          render: function render(_ref3) {
            ...
            return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_13__["TextField"], Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_6__["default"])({
              select: true,
              disabled: counterparty === '' || isSubmitting,
              variant: "outlined",
              style: {
            ...
            }, field), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("option", {
              disabled: true
  ...
  return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
    ...
    initialValues: fields.filter(function (field) {
      return field[0];
    })
    /*generateInitial(fields, new Array(fields.length).fill('')) */
    ,
    ...
    onSubmit: function onSubmit(values, actions) {
      var test = function test() {
        ...
        for (var i = 0; i < fields.length; i++) {
          result.push(fields[i][0]);
        }

        return result;
      };

      console.log(test()); //console.log(irsSchema(Object.values(values)));
...
//# sourceMappingURL=Main.js.d378b11686512dab606f.hot-update.js.map